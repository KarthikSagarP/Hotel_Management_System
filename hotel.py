...
class HotelManagementSystem:
    def __init__(self,root):
        ...
        #================image1====================
        img1=Image.open(r'gui\background.jpg')
        ...
        #================Logo=======================
        img2=Image.open(r'gui\logo.jpg')
        ...
        details_button = Button(button_frame, text='DETAILS', command=self.show_login_page, width=22, font=('times new roman', 14, 'bold'), fg='gold', bg='black', bd=0, cursor='hand1')
        details_button.grid(row=2,column=0,pady=1)
        
        report_button=Button(button_frame,text='ORDERS',command=self.order ,width=22,font=('times new roman',14,'bold'),fg='gold',bg='black',bd=0,cursor='hand1')
        report_button.grid(row=3,column=0,pady=1)
        
        #================ Right Side Image===============
        img3=Image.open(r'gui\side_image.jpg')
        ...
        #================ Down Image===============
        img4=Image.open(r'gui\food_logo.jpg')
        ...
        #================ Down Image===============
        img5=Image.open(r'gui\food1.jpg')
    ...
    def show_login_page(self):
        self.new_window = Toplevel(self.root)
        LoginPage(self.new_window, self.open_details_room)  # Pass the callback

    def open_details_room(self):
        self.new_window = Toplevel(self.root)
    ...
    def details_room(self):
        self.open_details_room()  # Call the method that opens the details room
